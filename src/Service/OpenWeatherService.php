...
class OpenWeatherService
{
    ...
    public function getWeatherFromOneCity(string $city){

        // //? GET request to unsplash
        $response = $this->client->request(
            'GET',
            'http://api.openweathermap.org/data/2.5/weather?q='.$city.',fr&lang=fr&units=metric',
            [
            'query' => [
                'appid' => $_ENV['OPEN_WEATHER_ACCES_KEY']
            ]
        ]);
